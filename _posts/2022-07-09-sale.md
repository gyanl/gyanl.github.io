...
*Kindle with a backlit screen. Great for reading on the go, the e-ink screen feels a lot like paper and the battery lasts forever. Newer kindles have smaller bezels and more lighting options but e-ink technology hasn't changed much, so this is still a great Kindle.*
...
#### Miniso Mint green wireless keyboard

_I just bought this because it looked really cute. I then lost the mouse to this is just the keyboard. Wireless USB receiver connects the keyboard to any device that supports USB keyboards. Runs on a single AA cell. _ 
