...
tags: branding
thumbnail: /assets/thumbs/hackindia.png
---

![HackIndia banner](/assets/hackindia.png)
...
![The logo, color scheme, mascot and app icon.](/assets/hackindia-style-guide.png)
...
![Login and Resume upload](/assets/hackindia-who-is.jpg)

###### A personal attempt to defeat the brogrammer stereotype.

![Login and Resume upload](/assets/hackindia-shs.jpg)

###### Kids were signing up, so we kept things PG-13.

![Login and Resume upload](/assets/hackindia-people.jpg)

###### All of the social media posts were designed around the same template so they looked like a cohesive part of the design.

![Login and Resume upload](/assets/hackindia-poster.jpg)

###### Print poster for the event.

![Login and Resume upload](/assets/hackasleep.png)
